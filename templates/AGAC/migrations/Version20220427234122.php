 ...
 */
final class Version20220427234122 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE other_informations ADD CONSTRAINT FK_6B409423A76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD CONSTRAINT FK_1483A5E93FBB336C FOREIGN KEY (other_informations_id) REFERENCES other_informations (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
